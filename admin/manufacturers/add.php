...
<head>
    ...
    <title>Панель администрирования | Добавление производителя смесителей</title>
    ...
    <script type="text/javascript" src="/js/admin/manufacturers/add.js"></script>
...
<div id="content">
    <span class="headerFont">Добавление нового производителя смесителей</span>
    <br /><br />
    <form method="post" id="manufacturersForm">
        <label for='manufacturerInput'>Название производителя:</label>
        <br />
        <input id='manufacturerInput' />
        <br /><br />
        <input type='button' class='button' id='manufacturerSubmit' value='Добавить' onmouseover='buttonHover("manufacturerSubmit", 1)' onmouseout='buttonHover("manufacturerSubmit", 0)' onclick='add()' />
    </form>
</div>
