...
$pageResult = $mysqli->query("SELECT * FROM akvasan_pages WHERE url = 'refund'");
...
<body>
    ...
    <div class="section white">
        <div class="header"><h1>Замена и возврат товара</h1></div>
        <div class="container text-left">
            <?php
                $textResult= $mysqli->query("SELECT text FROM akvasan_text WHERE url = 'refund'");
    ...
    <div class="topFooter">
        <div class="container">
            ...
            <div class="container25" id="footerRightContainer">
                <a href="/refund"><b>Замена и возврат товара</b></a>
                <br />
